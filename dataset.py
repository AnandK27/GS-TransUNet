...
def get_data(args):
    ...
    if 'isic' in data_str.lower():
        ############# Load training data
        data_train_root = '/3d_data/datasets/skin_cancer_1/ISIC/Training_Data/'
        data_train_add_root = '/3d_data/datasets/skin_cancer_1/ISIC/Training_Data/'
        ...
        ############# Load val data
        data_val_root = '/3d_data/datasets/skin_cancer_1/ISIC/Validation_Data/'
        ...
        data_test_ph2_root = '/3d_data/datasets/skin_cancer_1/PH2Dataset/PH2 Dataset images'
